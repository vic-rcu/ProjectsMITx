...
from project1 import accuracy, pegasos, classify
...
theta, theta_0 = pegasos(train_bow_features, train_labels, T, L)

predictions = classify(test_bow_features, theta, theta_0)
