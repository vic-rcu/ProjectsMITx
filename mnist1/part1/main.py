...
#     print("mod3", compute_test_error_mod3(test_x, test_y, theta, temp_parameter))
#
...
#
# theta, progression = softmax_regression(train_pca, train_y, 1, alpha=0.3, lambda_factor=1.0e-4, k=10,
#                                         num_iterations=150)

# class_y = get_classification(test_pca, theta, 1)
#
# print(class_y)
#
# print("error", compute_test_error(test_pca, test_y, theta, 1))
...
pred = svm_model.predict(test_pca10)

print("error: ", 1 - accuracy_score(pred, test_y))
